...
const HomeScreen = ({ navigation }) => {
    ...
    const handleOnSceenCreate = () => {
        navigation.navigate('CreateQuizScreen');
    };
    const handleOnQuizzPlay = (quiz) => {
        navigation.navigate('PlayQuizzScreen', {
            quizId: quiz.id,
        });
    };
    ...
    return (
        <SafeAreaView style={styles.safeArea}>
                ...
                renderItem={({ item: quiz }) => (
                    <View style={styles.quizsWrapper}>
                        ...
                        <TouchableOpacity
                            ...
                            onPress={() => handleOnQuizzPlay(quiz)}
                        >
                            <Text>Play</Text>
                        </TouchableOpacity>
                    </View>
            ...
            <FormButton
                ...
                handleOnPress={handleOnSceenCreate}
            />
        </SafeAreaView>
    );
};
